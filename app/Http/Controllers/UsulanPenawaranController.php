...
class UsulanPenawaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('usulan.index', compact('usulan', 'status', 'direction', 'companyId'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('usulan.create', compact('pics', 'products', 'bundleProducts', 'companies'));
    }
    ...
    public function show(UsulanPenawaran $usulan)
    {
        ...
        return view('usulan.show', compact(
            'usulan',
    ...
    public function downloadPdf(UsulanPenawaran $usulan)
    {
        ...
        $pdf = Pdf::loadView('usulan.pdf', compact(
            'usulan',
            'documentDate',
            'documentNumber',
            'kop',
    ...
    public function downloadQuotationPdf(UsulanPenawaran $usulan)
    {
        ...
        $pdf = Pdf::loadView('usulan.quotation_pdf', compact(
            'usulan',
            'penawaran',
            'requestDate',
    ...
    public function showQuotation(UsulanPenawaran $usulan)
    {
        ...
        return view('usulan.quotation_show', compact(
            'usulan',
            'isRequester',
            'isSupplier',
            'canEditQuotation',
    ...
    public function updateQuotation(Request $request, UsulanPenawaran $usulan)
    {
        ...
        return DB::transaction(function () use ($request, $payload, $penawaran, $usulan) {
            ...
            return redirect()->route('usulan.quotation.show', $usulan)
    ...
    public function edit(UsulanPenawaran $usulan)
    {
        ...
        return view('usulan.edit', compact('usulan', 'pics', 'products', 'bundleProducts', 'companies'));
    }
    ...
    public function tanggapi(Request $request, UsulanPenawaran $usulan)
    {
        ...
        return DB::transaction(function () use ($usulan, $payload, $action) {
            ...
            return redirect()->route('usulan.quotation.show', $usulan)->with('success', $message);
        });
    }
