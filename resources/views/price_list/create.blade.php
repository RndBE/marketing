        ...
        <div class="bg-white rounded-xl pb-4 pt-3 px-4  ">
            ...
            <form method="POST" action="{{ route('price_list.store') }}" class="space-y-3">
                ...
                <div>
                    ...
                    <input name="kode" class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm"
                        required>
                </div>

                <div>
                    <label class="block text-xs font-semibold mb-1">Nama</label>
                    <input name="nama" class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm"
                        required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4"
                        class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm"></textarea>
                </div>
