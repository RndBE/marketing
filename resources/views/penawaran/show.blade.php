    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="space-y-4" id="items-wrap">
                @forelse($penawaran->items as $itemIndex => $item)
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    <div class="flex flex-wrap items-start gap-2">
                                        <span class="mt-0.5 rounded-md bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-600">
                                            Item {{ $itemIndex + 1 }}
                                        </span>
                                ...
                                <tbody class="border border-slate-200 divide-y divide-slate-100 detail-sortable"
                                    ...
                                    @forelse($item->details as $d)
                                        ...
                                        <tr class="detail-row detail-view-{{ $d->id }}" draggable="true" data-detail-id="{{ $d->id }}">
                                            <td class="px-3 py-2 text-slate-500 text-xs">{{ $detailLabel($loop->index) }}.</td>
                                            <td class="px-3 py-2">
                                        ...
                                        <tr class="detail-edit-{{ $d->id }} hidden bg-slate-50">
                                            <td class="px-2 py-2 text-slate-400 text-xs align-top pt-3">{{ $detailLabel($loop->index) }}.</td>
